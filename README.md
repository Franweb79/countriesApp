...
Also seems to be problematic with ngIf and ngFor, so best way is to surround everything with a div with no conditions, directives or such, and apply animation there
